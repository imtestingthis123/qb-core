...
-- Utility
-- local blockAllExceptWalking = false

-- function QBCore.Functions.UseWhilstWalking(bool)
--     print(bool)
--     blockAllExceptWalking = bool
--     print(blockAllExceptWalking, "blockAllExceptWalking")
--     SetNuiFocus(bool, bool)
--     SetNuiFocusKeepInput(bool)
--     CreateThread(function()
--         while blockAllExceptWalking do
--             print("blocking")
--             Wait(0)
...
function QBCore.Functions.Notify(text, texttype, length)
    ...
    elseif texttype == 'success' then
        texttype = 'green'
        icon = 'check-circle'
    elseif texttype == 'info' then
        texttype = 'orange'
        icon = 'info-circle'
    elseif texttype == 'police' then
        texttype = 'blue'
        icon = 'info-circle'
    elseif texttype == 'ambulance' then
        texttype = 'orange'
        icon = 'info-circle'
    end
    ...
    if type(text) == "table" then
        ...
        TriggerEvent("qb-phone:client:CustomNotification", caption, ttext, icon, texttype, length)
    else
        texttype = texttype or 'primary'
        TriggerEvent("qb-phone:client:CustomNotification", "New Notification", text, icon, texttype, length)
    end
